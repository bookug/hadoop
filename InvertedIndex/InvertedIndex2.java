	...
	public static class NewMapper extends Mapper<Object, Text, Text, IntWritable>
	{
		...
		public void cleanup(Context context) throws IOException, InterruptedException 
		{
			...
			while(mit.hasNext())
			{
				...
				//NOTICE:the char ":" maybe exist in document, which will cause split to be error!
				//use "|" here and "\\|" in split is ok
...
//context.write(new Text("check reduce: "), new Text("same!!!"));
	...
	public static void main(String[] args) throws Exception
	{
		...
		conf.set("mapred.jar", "InvertedIndex2.jar");
		...
		{
			System.err.println("Usage: InvertedIndex2 <input> <output>");
			System.exit(2);
		}
