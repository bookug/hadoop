...
public class WordCount3
{
	...
	//also need combiners for optimazition, because only hashmap is in map()
	//it only speed up a doc, but not all docs assigning to this mapper
	//NOTICE:there is no way to build hashmap across all mappers(hadoop design!)
	...
	public static void main(String[] args) throws Exception
	{
		...
		conf.set("mapred.jar", "WordCount3.jar");
